function processForm(event) {
    ...
    if (!isValid) {
        ...
        return false; // Stops the function if the email is invalid
    }
    ...
    if (subscribe) {
        ...
        outputDiv.innerHTML += <p><strong>Newsletter Subscription:</strong> You chose not to subscribe to our newsletter.</p>;
    }
